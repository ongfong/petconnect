                    ...
                    <div className="mb-3 card">
                        <div className="no-gutters row">
                            <div className="col-md-4">
                                <section>
                                    <img
                                        ...
                                        style={{ height: '220px', width: '200px', marginTop: '15px', marginBottom: '15px', marginLeft: '15px', justifyContent: 'center' }}
                            ...
                            <div className="col-md-4">
                                ...
                                <div className="pb-3" style={nameStyle2}>Name: <strong>{pet.name}</strong></div>   
                ...
                <div className="inner-bar-center">
                    <ul className="nav">
                        <li className="nav-item">
                            <a role="tab" data-toggle="tab" className="nav-link active" href="#tab-content-0" aria-selected="true">
                                <span>Dog</span>
                            </a>
                        </li>
                        <li className="nav-item">
                            <a role="tab" data-toggle="tab" className="nav-link" href="#tab-content-1" aria-selected="false">
                                <span>Cat</span>
                            </a>
                        </li>
                        <li className="nav-item">
                            <a role="tab" data-toggle="tab" className="nav-link" href="#tab-content-2" aria-selected="false">
                                <span>Etc.</span>
                            </a>
                        </li>
                    </ul>
